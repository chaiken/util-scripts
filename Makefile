...
BINARY_LIST = cdecl hex2dec dec2hex cpumask endian endian_lib_test watch_file watch_one_file endian-cpp endlian_lib_test endian-cpp-valgrind cpumask cpumask_gtest cpumask-valgrind cpumask_ctest classify_process_affinity classify_process_affinity_lib_test timerlat_load_lib_test timerlat_load timerlat_pipe_load_lib_test timerlat_pipe_load_lib_test-tsan hanoi datasize
